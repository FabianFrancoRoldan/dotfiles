...
alias la='ls -A'
alias l='ls -CF'
alias kt='sh stopTrackPad.sh'
alias st='sh startTrackPad.sh'
alias nd='cd ~\Dev\node'
alias jd='cd ~\Dev\java'
alias gd='cd ~\Dev\go'
alias dotfiles='cd ~\Dev\dotfiles'

#aliases
alias goim="/mnt/data/scripts/goim.sh"

alias gopc="clear && goim && go test ./... -cover"
...
alias gobank="cd ~/Dev/go/src/sbsa.com/ost/"
